...
declare const logger: Logger<never, boolean>;
...
export { canUseDOM, contains, createObjectKeys, createQueryString, decodeUrl, deepMergeWithCombinedArrays, deepMergeWithReactComponents, deepMergeWithSourceArrays, encodeUrl, getClientSideURL, getNestedProperty, getServerSideURL, isNumber, isObject, isPlainObject, isReactClientComponent, isReactComponentOrFunction, isReactServerComponentOrFunction, logError, logger, mapAsync, parseSearchParams, removeUndefined, slugify, toCapitalized, toKebabCase, truncate };
