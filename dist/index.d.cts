...
import pino, { Logger, DestinationStream, pino as pino$1 } from 'pino';
...
declare const logError: ({ err, config }: {
    err: unknown;
    config: LoggerConfig;
}) => void;
...
declare const prettySyncLoggerDestination: PinoPretty.PrettyStream;
 ...
 */
declare const getLogger: (name?: string, logger?: "sync" | {
    destination?: DestinationStream;
    options: pino$1.LoggerOptions;
}) => CustomLogger;
...
export { type CustomLogger, canUseDOM, contains, createObjectKeys, createQueryString, decodeUrl, deepMergeWithCombinedArrays, deepMergeWithReactComponents, deepMergeWithSourceArrays, defaultLoggerOptions, encodeUrl, getClientSideURL, getLogger, getNestedProperty, getServerSideURL, isNumber, isObject, isPlainObject, isReactClientComponent, isReactComponentOrFunction, isReactServerComponentOrFunction, logError, mapAsync, parseSearchParams, prettySyncLoggerDestination, removeUndefined, slugify, toCapitalized, toKebabCase, truncate };
